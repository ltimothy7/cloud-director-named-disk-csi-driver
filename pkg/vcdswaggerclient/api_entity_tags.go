...
type EntityTagsApiService service

/*
EntityTagsApiService Retrieves the tag information for a specific entity.
 ...
 * @param id the URN of the entity to manage tag for.

@return EntityTags
*/
func (a *EntityTagsApiService) GetEntityTags(ctx context.Context, id string) (EntityTags, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EntityTags
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/entity/{id}/tags"
...
/*
EntityTagsApiService Retrieves the list of entities that have at least one tag assigned to it.
 ...
 * @param optional nil or *EntityTagsApiGetEntityTagsSummariesOpts - Optional Parameters:
...
@return EntityTagsSummaries
*/

type EntityTagsApiGetEntityTagsSummariesOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *EntityTagsApiService) GetEntityTagsSummaries(ctx context.Context, page int32, pageSize int32, localVarOptionals *EntityTagsApiGetEntityTagsSummariesOpts) (EntityTagsSummaries, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EntityTagsSummaries
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tags/entityTagsSummaries"
...
/*
EntityTagsApiService Update the tag information for a specific entity.
...
@return EntityTags
*/
func (a *EntityTagsApiService) UpdateEntityTags(ctx context.Context, entityTags EntityTags, id string) (EntityTags, *http.Response, error) {
	var (
