...
type PvdcStoragePolicy struct {
	...
	// Urn of the PVDC that this policy belongs to.
	ProviderVdcUrn string `json:"providerVdcUrn"`
	// Urn of the Virtual Center that this policy belongs to.
	VcUrn string `json:"vcUrn"`
}
