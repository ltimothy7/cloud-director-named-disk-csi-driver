...
@return PvdcStoragePolicySupportedEntityTypes
*/
...
func (a *PvdcStoragePolicyApiService) GetPvdcStoragePolicySupportedEntityTypes(ctx context.Context, page int32, pageSize int32, pvdcStoragePolicyUrn string, localVarOptionals *PvdcStoragePolicyApiGetPvdcStoragePolicySupportedEntityTypesOpts) (PvdcStoragePolicySupportedEntityTypes, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PvdcStoragePolicySupportedEntityTypes
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PvdcStoragePolicySupportedEntityTypes
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
@return PvdcStoragePolicySupportedEntityTypes
*/
func (a *PvdcStoragePolicyApiService) UpdatePvdcStoragePolicySupportedEntityTypes(ctx context.Context, updatedSupportedEntityTypes PvdcStoragePolicySupportedEntityTypes, pvdcStoragePolicyUrn string) (PvdcStoragePolicySupportedEntityTypes, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
