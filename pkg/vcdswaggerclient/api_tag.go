...
/*
TagApiService Retrieves the list of unique scopes associated with tags.
 ...
 * @param optional nil or *TagApiGetScopesOpts - Optional Parameters:
...
type TagApiGetScopesOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *TagApiService) GetScopes(ctx context.Context, page int32, pageSize int32, localVarOptionals *TagApiGetScopesOpts) (Scopes, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue Scopes
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tags/scopes"
...
/*
TagApiService Retrieves the list of tags.
 ...
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *TagApiGetTagsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
type TagApiGetTagsOpts struct { 
	Filter optional.String
	SortAsc optional.String
	SortDesc optional.String
}

func (a *TagApiService) GetTags(ctx context.Context, page int32, pageSize int32, localVarOptionals *TagApiGetTagsOpts) (Tags, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tags/"
