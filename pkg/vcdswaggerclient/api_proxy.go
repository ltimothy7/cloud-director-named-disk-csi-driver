...
func (a *ProxyApiService) GetProxiesPacFileForTenant(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"application/x-ns-proxy-autoconfig;version=35.0"}
...
func (a *ProxyApiService) GetProxyCRL(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"application/x-pkcs7-crl;version=35.0"}
...
func (a *ProxyApiService) GetProxyCertificate(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"application/x-x509-ca-cert;version=35.0", "application/x-pem-file;version=35.0"}
...
/*
ProxyApiService Retrieve a Proxy SSL certificate thumbprint and algorithm used for calculation.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Proxy ID URN
