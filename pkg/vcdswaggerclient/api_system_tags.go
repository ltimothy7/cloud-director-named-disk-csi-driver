...
type SystemTagsApiService service

/*
SystemTagsApiService Retrieves the list of system tags.
...
@return SystemTags
*/
func (a *SystemTagsApiService) GetSystemTags(ctx context.Context) (SystemTags, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SystemTags
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tags/systemTags"
...
/*
SystemTagsApiService Update the list of system tags.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemTags the list of tags to update.

@return SystemTags
*/
func (a *SystemTagsApiService) UpdateSystemTags(ctx context.Context, systemTags SystemTags) (SystemTags, *http.Response, error) {
	var (
