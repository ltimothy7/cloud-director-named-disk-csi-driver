...
type OrgVdcStoragePolicy struct {
	...
	// Urn of the Org VDC that this policy belongs to.
	VdcUrn string `json:"vdcUrn"`
	// Urn of the flavor PVDC Storage Policy.
	PvdcStoragePolicyUrn string `json:"pvdcStoragePolicyUrn,omitempty"`
}
