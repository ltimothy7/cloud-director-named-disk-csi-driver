...
@return Session
*/
func (a *SessionsApiService) GetCurrentSession(ctx context.Context, id string) (Session, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SessionsApiService Returns the session associated with the authorization credential
Returns the specified session for the authorization token 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Session
*/
func (a *SessionsApiService) GetCurrentSessionForAuthCredential(ctx context.Context) (Session, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
